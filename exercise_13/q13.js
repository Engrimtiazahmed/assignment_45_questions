...
let favTrans = ['honda civic', 'honda motercycle', 'toyota'];
console.log("I would like to own a " + favTrans[0] + " SUV car");
console.log("I would like to own a " + favTrans[1] + " 125 bike");
console.log("I would like to own a " + favTrans[2] + " Grande Car");
